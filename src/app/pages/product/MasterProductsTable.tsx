...
import { MasterItemApi, MasterItemListResponse, GenderType } from "../../../api";
      ...
      Cell: ({ row }) => (
        <div className="d-flex align-items-center">
          <div className="symbol symbol-50px me-5">
            <img
              src={row.original.images?.[0] || toAbsoluteUrl("media/stock/600x400/img-placeholder.jpg")}
      ...
      <div className={`card ${className}`}>
        <div className="card-header border-0 pt-5">
          <h3 className="card-title align-items-start flex-column">
            <span className="card-label fw-bold fs-3 mb-1">Master Products</span>
