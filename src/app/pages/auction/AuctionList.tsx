...
import { ConsignSale, FashionItemApi } from "../../../api";
    ...
    <>
        ...
        <div className="table-responsive">
          ...
          >
            ...
            <tbody className="text-gray-600 fw-semibold">
              {data!.data.items?.map((auctionItems) => (
                <tr key={auctionItems.itemId}>
                  <td>{auctionItems.itemCode}</td>
                  <td>{auctionItems.type}</td>
      ...
      <div className="card-footer d-flex justify-content-between align-items-center">
        <div>
          ...
          {Math.min(currentPage * pageSize, data!.data.totalCount!)} of{" "}
          {data?.data.totalCount} entries
        </div>
        <div>
          <button
