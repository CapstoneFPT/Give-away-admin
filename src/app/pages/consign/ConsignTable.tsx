              ...
              <tbody>
                {data!.items?.map((consignSale: ConsignSaleListResponse) => (
                  <tr key={consignSale.consignSaleId}>
                    ...
                    <td>
                      {consignSale.startDate
                        ? new Date(consignSale.startDate).toLocaleDateString()
                        : "N/A"}
                    </td>
                    <td>
                      {consignSale.endDate
                        ? new Date(consignSale.endDate).toLocaleDateString()
                        : "N/A"}
                    </td>
                    <td>
                      <span
                    ...
                    <td>
                      {formatBalance(consignSale.memberReceivedAmount || 0)} VND
                    </td>
