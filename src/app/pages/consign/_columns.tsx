...
const consignSaleColumns : Column<ConsignSaleListResponse>[] =
    [
        ...
        },
        {
            ...
            Cell: ({ value }: { value: string | undefined }) => value ? new Date(value).toLocaleString() : 'N/A',
        },
        {
            Header: 'Start Date',
            accessor: 'startDate',
            Cell: ({ value }: { value: string | undefined | null }) => value ? new Date(value).toLocaleString() : 'N/A',
        },
        {
            Header: 'End Date',
            accessor: 'endDate',
